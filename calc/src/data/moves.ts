...
// PokeMMO Star Skills (☆) - enhanced variants of existing moves
// BP values extracted from PokeMMO data.pak; status moves keep bp: 0
const STAR_SKILL_BP: {[name: string]: number} = {
  'Ice Punch': 95,
  'Thunder Punch': 95,
  'Swords Dance': 0,
  'Whirlwind': 0,
...
// Generate star skill entries by cloning base moves and overriding BP
for (const baseName in STAR_SKILL_BP) {
  if (SV[baseName]) {
    SV[baseName + '☆'] = extend(true, {}, SV[baseName], {bp: STAR_SKILL_BP[baseName]});
  }
}
